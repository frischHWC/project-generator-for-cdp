...
def main():
    ...
    render_code_files(env=env,
                      ...
                      hdfs_work_dir=dict_of_options.get("hdfs-workdir"),
                      ...
                      hadoop_home=dict_of_options.get("hadoop-home"),
                      haddop_user=dict_of_options.get("hadoop-user"),
                      kerberos_auth=dict_of_options.get("kerberos-auth"),
                      kerberos_keytab=dict_of_options.get("kerberos-keytab"),
                      kerberos_user=dict_of_options.get("kerberos-user"),
                      keystore_location=dict_of_options.get("keystore-location"),
                      keystore_password=dict_of_options.get("keystore-password"),
                      keystore_key_password=dict_of_options.get("keystore-key-password"),
                      truststore_location=dict_of_options.get("truststore-location"),
                      truststore_password=dict_of_options.get("truststore-password"),
                      hdfs_nameservice=dict_of_options.get("hdfs-nameservice"),
                      zookeeper_quorum=dict_of_options.get("zookeeper-quorum"),
                      ozone_nameservice=dict_of_options.get("ozone-nameservice"),
                      solr_server=dict_of_options.get("solr-server"),
                      kafka_broker=dict_of_options.get("kafka-broker"),
                      kafka_security_protocol=dict_of_options.get("kafka-security-protocol"),
                      schema_registry=dict_of_options.get("schema-registry"),
                      kudu_master=dict_of_options.get("kudu-master")
                      )
